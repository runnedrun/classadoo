...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderClassInfoDisplay() {
		ReactDOM.render(React.createElement(ClassInfoDisplay, { klass: klass }), document.getElementById("class-info-container"));
	}

	function renderStudentStatesDisplay() {
		var statesArr = Util.objectValues(students);
		var studentNames = statesArr.map(function (state) {
		...
		ReactDOM.render(React.createElement(StudentStatesDisplay, { studentStates: alphaStates }), document.getElementById("student-state-wrapper"));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactIsomorphic = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEmptyComponentRegistry = __webpack_require__(95);
	var ReactInstanceHandles = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponent = __webpack_require__(174);
	var ReactElement = __webpack_require__(93);
	var ReactPropTypeLocations = __webpack_require__(116);
	var ReactPropTypeLocationNames = __webpack_require__(117);
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "h3",
	          { "data-field": "name", onKeyDown: this.updateClassData, onClick: this.makeEditable },
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          "h3",
	          { className: "input-group input-group-large" },
	          React.createElement(
	            "span",
	          ...
	          React.createElement(
	            "span",
	            { className: "form-control", "data-field": "currentLesson", onKeyDown: this.updateClassData, onClick: this.makeEditable },
...
/***/ function(module, exports, __webpack_require__) {
	...
	StudentStatesDisplayRow = React.createClass({
	  displayName: "StudentStatesDisplayRow",
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      this.props.states.map(function (state) {
	        return React.createElement(StudentState, { key: state.studentName, state: state });
	      })
	    );
	  }
	});
	...
	StudentStatesDisplay = React.createClass({
	  displayName: "StudentStatesDisplay",
	  ...
	  statesObjToRows: function () {
	    ...
	    while (statesCopy.length > 0) rows.push(statesCopy.splice(0, rowSize));
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      this.statesObjToRows().map(function (stateRow, i) {
	        return React.createElement(StudentStatesDisplayRow, { key: i, states: stateRow });
	      })
	    );
	  }
	});
